...
public function index()
{
    ...
    $jadwalBerikutnya = \App\Models\JadwalPosyandu::whereDate('tanggal', '>=', now()->toDateString())
        ->orderBy('tanggal')
        ->orderBy('waktu')
        ->first();

    return view('dashboard-ortu', compact('anak', 'imunisasiList', 'usiaSekarang', 'jadwalBerikutnya'));
}
}
