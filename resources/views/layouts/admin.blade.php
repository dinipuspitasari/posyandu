...
<body class="h-full bg-gray-50/40 font-[Inter]">
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <span class="self-center text-lg font-bold whitespace-nowrap text-gray-800">POSYANDU GANGGANG</span>
                    </a>
                </div>
    ...
    <aside id="sidebar-multi-level-sidebar"
        class="fixed top-0 left-0 z-40 w-60 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 bg-white/90 shadow-md"
        aria-label="Sidebar">
        @if (Auth::user()->id == 1)
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="/dashboard"
                            class="flex items-center p-2 text-gray-800 rounded-lg hover:bg-blue-200 hover:text-blue-900 transition-colors duration-200">
    ...
    {{-- footer di bawah ini --}}
    <footer class="text-center py-4 border-t mt-10 text-gray-500 text-sm">
