...
@section('title', 'Posyandu Ganggang | Data Imunisasi')
...
@section('content')
    ...
    {{-- Judul --}}
    <h2 class="text-xl font-semibold mb-6">Data Imunisasi</h2>

    {{-- Entries --}}
    <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-2 sm:gap-4 mb-4">
        <form method="GET" action="{{ route('imunisasi.index') }}" class="flex items-center">
        ...
        <form method="GET" action="{{ route('imunisasi.index') }}" class="flex items-center">
            ...
            {{-- searching --}}
            <form method="GET" action="{{ route('imunisasi.index') }}" class="w-full flex items-center" id="searchForm">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-700">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-4 py-2 border">Nama Imunisasi</th>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2 border">
                            <div class="flex items-center justify-center space-x-1">
                                ...
                                {{-- Tombol Edit --}}
                                <a href={{ route('imunisasi.edit', $item->id_imunisasi) }} type="button"
                                ...
                                {{-- Tombol Hapus --}}
                                <form action="{{ route('imunisasi.destroy', $item->id_imunisasi) }}" method="POST"
                                    onsubmit="return confirm('Anda Yakin ingin Menghapus {{ $item->name }} ?')"
    ...
    <div class="flex items-center justify-between mt-4 mx-5">
        ...
        <div class="flex space-x-1">
            ...
            {{-- Halaman aktif --}}
            <span class="px-3 py-1 bg-blue-600 text-white rounded text-sm">{{ $data->currentPage() }}</span>
