    ...
    <div class="p-6 bg-white rounded-lg shadow">
        ...
        <form action="{{ route('jadwal.store') }}" method="POST">
            ...
            <div class="flex justify-end gap-3 mt-6">
                <a href="{{ route('jadwal.index') }}" class="px-4 py-2 text-sm bg-white border-black border rounded-lg hover:bg-gray-400">Kembali</a>
                <button type="submit" class="px-4 py-2 bg-blue-600 text-sm text-white rounded-lg hover:bg-blue-700">Simpan</button>
            </div>
        </form>
    </div>
@endsection
